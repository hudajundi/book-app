INSERT INTO books (author, title, bookshelf, isbn, image_url, description)

VALUES
('Christiaan Huygens',
'Treatise On Light',
'Books to Read',
'ISBN_13 9783752308167',
'http://books.google.com/books/content?id=-8nxDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
'Reproduction of the original: Treatise On Light by Christiaan Huygens'),
('Andrew Warren',
'Dunes',
'Books to Read',
'ISBN_13 9781118295809',
'http://books.google.com/books/content?id=yCTpMjHRkAwC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api',
